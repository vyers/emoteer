...
Map Emoteer variables to the tokens from your own Tailwind theme. Works with both v3 and v4.
...
If you want none of the defaults, skip the CSS import and style every slot yourself. All primitives are unstyled when no CSS is present.
