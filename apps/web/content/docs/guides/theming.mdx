...
On Tailwind v4? Import the preset from your main CSS instead, to also get the
...
scroll-area and popover internals expose their underlying [Zag](https://zagjs.com/)
scopes (`[data-scope='slider']`, `[data-scope='scroll-area']`,
`[data-scope='popover'][data-state='open']`). See the
[component reference](/docs/components/emote-list) for the full part list.
