...
Primitives are headless by default. Adding `@import '@emoteer/react/tailwind'` to your app's CSS opts into the bundled styles. All classes are namespaced and can be overridden through CSS variables or per-slot `className` merging.
