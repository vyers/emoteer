...
| --- | --- | --- |
| `onSelect` | `(emote: NativeEmoji, nextValue: string) => void` | Called when a suggestion is chosen. The second argument is the final input value with the emoji inserted. |
